...
insert into userr (user_id, email, last_name, login, name, password, phone)
values (2, 'test1@email.com', 'test1', 'test1', 'test1', 'pwd', '1234567234');

insert into doctor (certificate_number, specialization, doctor_id)
values ('124345', 'doctor1', 2);

insert into userr (user_id, email, last_name, login, name, password, phone)
values (3, 'test2@email.com', 'test2', 'test2', 'test2', 'pwd', '1234568345');

insert into doctor (certificate_number, specialization, doctor_id)
values ('124345', 'doctor1', 3);